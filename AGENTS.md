...
## Inference backends
- **llama.cpp** (default): localhost:8081 — serves qwen3-coder:30b, qwen3.6:35b-a3b, qwen2.5-coder:7b
- **BeeLlama.cpp** (optional): localhost:8082 — serves qwen3.6-27b with DFlash speculative decoding + vision
